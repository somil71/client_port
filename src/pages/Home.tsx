...
const highlights = [
  {
    ...
    copy: 'Creative direction, motion feedback, and design iteration shaped to feel live, connected, and fast-moving.',
  },
  {
    title: 'Morphing animation effects',
    copy: 'Liquid transitions, shape-to-shape motion, and elastic scene changes that keep edits feeling fluid instead of mechanical.',
  },
  {
    title: 'Visual storytelling',
    copy: 'From logos and graphic panels to motion frames and characters, each element is treated like part of one continuous story.',
  },
]

const featuredProjects = [
  {
    title: 'Motion Identity Studies',
    format: 'Motion Graphics',
    summary: 'Fast visual systems built from rhythm, typography, and morphing transitions tailored for reels and promos.',
  },
  {
    title: 'Collaborative Edit Frames',
    format: 'Digital Filmmaking',
    summary: 'Short-form storytelling experiments shaped around shared review loops, edit beats, and composited frames.',
  },
  {
    title: 'Liquid Interface Studies',
    format: 'Graphic Design + Frontend',
    summary: 'Case-study pages and portfolio screens that blend responsive presentation with fluid, shape-shifting motion cues.',
  },
]
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="space-y-8 min-w-0">
            <span className="eyebrow">Somil / Design / Motion / Editing / Web</span>
            <div className="space-y-6">
              <h1 className="display-hero max-w-4xl">
                Real-time ideas,
                <span className="block accent-text">morphed into motion</span>
                and clear visual stories.
              </h1>
              <p className="muted-copy text-lg lg:text-xl max-w-2xl leading-relaxed">
                I design portfolio experiences around fast creative exchange, morphing animation effects,
                and cinematic pacing so every transition feels intentional, fluid, and alive.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              {['Graphic Design', '2D Animation', 'Morphing Motion', 'VFX'].map((item) => (
          ...
          >
            ...
            <div className="relative min-h-[31rem] sm:min-h-[34rem] rounded-[1.5rem] overflow-hidden border border-white/10 bg-[radial-gradient(circle_at_top,_rgba(255,155,113,0.22),_transparent_38%),linear-gradient(180deg,_rgba(38,25,22,0.85),_rgba(13,10,10,0.95))]">
              ...
              <div className="absolute inset-x-6 top-5 flex items-start justify-between gap-3">
                <div className="pill text-xs max-w-[13rem] sm:max-w-none">Real-time collaborative animations</div>
              ...
              <div className="absolute left-6 right-6 top-[42%] z-10">
                <div className="glass-panel rounded-[1.2rem] p-4">
                  <p className="text-[0.68rem] uppercase tracking-[0.3em] text-white/45 mb-2">Transition system</p>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <p className="text-sm muted-copy">logo to frame to character to scene</p>
                  </div>
                </div>
              </div>
              <div className="absolute bottom-0 inset-x-0 p-6 lg:p-8">
                ...
                <p className="text-2xl lg:text-3xl font-grotesk max-w-sm leading-tight">
                  Liquid transitions,
                  <span className="block accent-soft">fast visual feedback, and authored motion language.</span>
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <section className="mb-24 lg:mb-32">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
            <div className="space-y-3 min-w-0">
              ...
              <h2 className="section-title">Built for flow, feedback, and shape-shifting motion.</h2>
            </div>
            <p className="muted-copy max-w-md hidden md:block">
              The first screen now leans into collaborative animation energy, with motion language
              that feels fluid enough for liquid transitions and fast visual storytelling.
            </p>
          </div>
        ...
        <section className="mb-24 lg:mb-32">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
            <div className="space-y-3 min-w-0">
              ...
              <h2 className="section-title">Presentation-ready work with more motion energy.</h2>
            </div>
            <p className="muted-copy max-w-md hidden md:block">
              Each card now echoes the homepage direction: collaborative pacing, morphing form language,
              and stronger motion cues across the portfolio.
            </p>
          </div>
        ...
        <section className="grid xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] gap-8 lg:gap-12 items-start mb-24 lg:mb-32">
          <div className="space-y-4 min-w-0">
            ...
            <h2 className="section-title">Fluid motion thinking across creative and technical work.</h2>
            <p className="muted-copy leading-relaxed">
              The goal is not just to show finished work, but to make the page itself feel like part
              of the animation system through motion, transitions, and responsive composition.
            </p>
          </div>

          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4 min-w-0">
            {[
              { number: 'Live', label: 'Collaborative energy carried through the hero and previews' },
              { number: 'Fluid', label: 'Morph-inspired transition language across major sections' },
              { number: '100%', label: 'Responsive motion-first presentation for desktop and mobile' },
            ].map((stat, idx) => (
              <motion.div
                key={stat.label}
        ...
        >
          <div className="grid xl:grid-cols-[minmax(0,1fr)_auto] gap-8 items-center">
            <div className="space-y-4 min-w-0">
              ...
              <h2 className="section-title">Explore the full portfolio or send a project inquiry.</h2>
              <p className="muted-copy max-w-2xl leading-relaxed">
                The work page now organizes the required categories, and the contact page stays open without
                a sign-in wall so reviewers can reach you directly.
              </p>
            </div>
